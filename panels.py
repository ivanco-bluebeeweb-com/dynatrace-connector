"""Panel UI for Dynatrace Connector following UI_INTERFACE_STANDARD.md."""
...
def _help_modal() -> ui.UINode:
    return ui.Modal(
        ...
        children=[
            ui.Text(
                "1. Sign in to your Dynatrace dashboard and navigate to API/Integration settings.\n"
...
async def main_panel(ctx) -> ui.UINode:
    ...
    return ui.Stack(
        ...
        gap=2,
        children=[
            ui.Heading("Dynatrace Connector", level=3),
            ui.Text("Connect and manage your Dynatrace workspace.", variant="caption"),
            ui.Divider(),
            form,
            ui.Divider(),
            _help_modal(),
