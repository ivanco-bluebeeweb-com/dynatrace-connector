"""Settings panel for Dynatrace Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__dynatrace_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=dynatrace_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_dynatrace"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Dynatrace Settings & Accounts", level=2),
